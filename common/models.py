...
class Issue(models.Model):
    ...
    status_text = models.TextField(max_length=1000, null=True, blank=True, verbose_name=_('status text'), help_text=_('Further details explaining the progress / plans / challanges / milestones / ... .'))
